...
const s = {
  ...
  pill: { display:"flex", flexDirection:"column", alignItems:"center",
    width:82, height:82, justifyContent:"center", textAlign:"center",
  ...
  pillSym:   { fontSize:16, color:"#a03860", lineHeight:1, marginBottom:3, display:"block", width:"100%", textAlign:"center" },
  pillSign:  { fontFamily:"'Cinzel',serif", fontSize:13, color:"#a03860", letterSpacing:".06em", display:"block", width:"100%", textAlign:"center" },
  pillLabel: { fontSize:9, color:"#a06880", letterSpacing:".14em", textTransform:"uppercase", marginTop:3, display:"block", width:"100%", textAlign:"center" },
  pillSun: { display:"flex", flexDirection:"column", alignItems:"center",
    width:120, height:120, justifyContent:"center", textAlign:"center",
  ...
  pillSymSun:   { fontSize:26, color:"#a03860", lineHeight:1, marginBottom:6, display:"block", width:"100%", textAlign:"center" },
  pillSignSun:  { fontFamily:"'Cinzel',serif", fontSize:21, color:"#a03860", letterSpacing:".08em", display:"block", width:"100%", textAlign:"center" },
  pillLabelSun: { fontSize:12, color:"#a06880", letterSpacing:".16em", textTransform:"uppercase", marginTop:5, display:"block", width:"100%", textAlign:"center" },
